...
public class ProductController {
	...
	public ResponseEntity<ProductResponse> getProductsByBrand(
		...
		ProductResponse productResponse = productService.getProductsByBrand(brandId, pageNumber, pageSize, sortBy, sortOrder);
		return new ResponseEntity<>(productResponse, HttpStatus.OK);
	}
	@GetMapping("/public/categories/{categoryId}/brands/{brandId}/products")
	public ResponseEntity<ProductResponse> getProductsByCategoryAndBrand(
		...
		ProductResponse productResponse = productService.searchByCategoryAndBrand(
				categoryId, brandId, pageNumber, pageSize, sortBy, sortOrder);
